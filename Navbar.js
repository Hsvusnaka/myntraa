        ...
        <div className='2xl:grid xl:grid grid-cols-2 lg:flex h-full mx-6  '>
          ...
          <div className=' h-full justify-center items-center '>
            <ul className='flex float-right  h-full  text-[#282c3f] tracking-[.3px] sent'>
              ...
              {/* Canvas Button */}
              <li className='w-max flex justify-center items-center font1 font-semibold capitalize no-underline text-sm border-4 border-transparent mr-2'>
                <Link to='/canvas'>
                  <h1 className='px-3 text-xs text-center relative' style={{color: '#282c3f'}}>
              ...
              <li className='w-max flex justify-center items-center font1 font-semibold capitalize no-underline text-sm border-4 border-transparent mr-2'>
                <Link to='/ai-stylist'>
                  <h1 className='px-3 text-xs text-center relative' style={{color: '#E35E7E'}}>
                    <span className='text-lg absolute -top-5 left-1/3'><BsStars /></span>
                    AI Stylist
                  </h1>
                </Link>
              </li>
